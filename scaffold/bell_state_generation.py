...
from ql_bit_generator import couple_graphs_custom
...
def sample_eigenvalue_distributions(N, k, l, M=100):
    ...
    for i in range(M):
        ...
        ql_bit_matrix1 = couple_graphs_custom(k_reg_adj_mats[0], k_reg_adj_mats[1], l)
        ql_bit_matrix2 = couple_graphs_custom(k_reg_adj_mats[2], k_reg_adj_mats[3], l)
